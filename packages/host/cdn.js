const envLib = {
  development: {
    react: 'React@https://cdn.jsdelivr.net/npm/react@18.2.0/umd/react.development.js',
    'react-dom': 'ReactDOM@https://cdn.jsdelivr.net/npm/react-dom@18.2.0umd/react-dom.development.js'
  },
  production: {
