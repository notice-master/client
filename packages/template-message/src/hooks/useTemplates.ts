...
export const useTemplates = () => {
  ...
  const [normalTemplates, setNormalTemplates] = useState<ITemplateData[]>([]);
  const [categrayTemplates, setCategrayTemplates] = useState<ITemplateData[]>(
    []
  );
  ...
  return [...normalTemplates, ...categrayTemplates];
};
